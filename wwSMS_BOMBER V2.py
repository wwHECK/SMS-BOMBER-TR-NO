...
else :a!=8400  and stop() and print(K+" yanlış şifre giriş onaylanmadı son 3 hakkınız var")
time. sleep (6) 

webbrowser.open("https://youtube.com/@weoxyt?si=ukdMkOCQbs5--wBQ")
time. sleep (3)
webbrowser.open("https://t.me/weoxYT19")
...
EQ=print("""____   ___  __  __ ____  _____ ____                                  | __ ) / _ \|  \/  | __ )| ____|  _ \                                 |  _ \| | | | |\/| |  _ \|  _| | |_) |                                | |_) | |_| | |  | | |_) | |___|  _ <
